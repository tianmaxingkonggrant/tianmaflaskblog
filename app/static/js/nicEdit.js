...
var nicEditorConfig = bkClass.extend({
	buttons : {
		...
		'center' : {name : __('中间对齐'), command : 'justifycenter', noActive : true},
		...
		'ul' : 	{name : __('添加无序列列'), command : 'insertunorderedlist', tags : ['UL']},
		'subscript' : {name : __('Click to Subscript'), command : 'subscript', tags : ['SUB']},
		'superscript' : {name : __('Click to Superscript'), command : 'superscript', tags : ['SUP']},
		'strikethrough' : {name : __('Click to Strike Through'), command : 'strikeThrough', css : {'text-decoration' : 'line-through'}},
		'removeformat' : {name : __('移除样式'), command : 'removeformat', noActive : true},
		'indent' : {name : __('缩进文本'), command : 'indent', noActive : true},
		'outdent' : {name : __('移除缩进'), command : 'outdent', noActive : true},
		'hr' : {name : __('水平规则'), command : 'insertHorizontalRule', noActive : true}
	},
...
var nicEditorFontFormatSelect = nicEditorSelect.extend({
		sel : {'p' : '段落', 'pre' : '预定义', 'h6' : '6级标题', 'h5' : '5级标题', 'h4' : '4级标题', 'h3' : '3级标题', 'h2' : '2级标题', 'h1' : '1级标题'},
...
var nicColorOptions = {
	buttons : {
		'forecolor' : {name : __('改变文本颜色'), type : 'nicEditorColorButton', noClose : true},
